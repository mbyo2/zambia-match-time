-- Drop and recreate the enhanced compatible profiles function with correct types
DROP FUNCTION public.get_enhanced_compatible_profiles(uuid,integer,integer,integer,text[],text[],text[],integer,integer,text[],text[],text,text,text);
